\section{Práctica 1: Periféricos mapeados en memoria (MMIO): Entrada/Salida de propósito general (GPIO)}
    ...
    \subsection{Fundamentos teóricos}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{practica1/res/stm32f723mm.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{practica1/res/stm32f723mm_detail.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{practica1/res/stm32f723_gpio_moder_reg.png}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\textwidth]{practica1/res/stm32f723_discovery_pins.png}
    ...
    \subsection{Desarrollo de la práctica}
        ...
        \subsubsection{Creación del proyecto}
            ...
            \begin{enumerate}
                \item Abrimos STM32CubeIDE, buscándolo en el menú del sistema. Elegimos un workspace (o carpeta de trabajo) donde trabajar. Tras abrirlo, veremos el programa de la \Cref{fig:scrn_01_startup}
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_01_startup.png}
                ...
                \item Seleccionamos \texttt{STM32CubeIDE Empty Project} (\Cref{fig:scrn_02_project})
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_02_project.png}
                ...
                \item En \texttt{Board Selector}, buscar \texttt{723e} y seleccionar la única placa disponible (\Cref{fig:scrn_03_boardsel}).
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_03_boardsel.png}
                ...
                \item Finalmente, dar un nombre al proyecto y terminar (\Cref{fig:scrn_04_namesel}).
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_04_namesel.png}
        ...
        \subsubsection{Depuración del proyecto}
            ...
            Ahora deberíamos tener un proyecto en blanco para trabajar (\Cref{fig:scrn_06_structure}). Antes de nada, vamos a probar que la conexión con la placa funciona, y podemos compilar y depurar el proyecto. Para ello:
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=\textwidth]{practica1/res/scrn_06_structure.png}
            ...
            \begin{enumerate}
                ...
                \item Con el archivo abierto, haz click en el martillo (build) que se encuentra en la barra superior de tareas. Verás el log de compilación en la terminal (\Cref{fig:scrn_07_build}).
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_07_build.png}
                ...
                \item Acepta la configuración de depuración por defecto (\Cref{fig:scrn_08_debugsel}) y vuelve a aceptar cuando pida cambiar a la vista de depuración.
                    ...
                    \begin{figure}
                        \centering
                        \includegraphics[width=\textwidth]{practica1/res/scrn_08_debugsel.png}
            ...
            Se recomienda explorar todas estas funcionalidades, que se pueden ver en la \Cref{fig:scrn_11_debugpersonalized}.
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=\textwidth]{practica1/res/scrn_11_debugpersonalized.png}
        ...
        \subsubsection{Solución}
            ...
            \lstinputlisting{practica1/src/main.c}