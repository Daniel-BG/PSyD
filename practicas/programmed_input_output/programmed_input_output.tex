...
\ifSubfilesClassLoaded{\setcounter{numpractica}{2}}{}


\practica{Entrada / Salida programada - UART TX}
    ...
    \subsection{Desarrollo de la práctica}
        ...
        \textbf{NOTA:} Si no está instalada la utilidad \texttt{picocom}, se puede instalar con:
