...
\ifSubfilesClassLoaded{\setcounter{numpractica}{1}}{}


\practica{Creación de un \textit{Board Support Package} (BSP)}
        ...
        \begin{enumerate}
            \item Completar la definición de tipo para incluir todos los registros. También completar la definición de tipo de \REG{AHB1ENR}.
                ...
                \begin{lstlisting}
                    ...
                    #define RCC_AHB1ENR 		((RCC_AHB_ENR_TypeDef *) RCC_AHB1EN_BASE_ADDR)
                \end{lstlisting}
            \item Crear las funciones, junto con sus definiciones de valores, para controlar los diferentes registros. Toma el ejemplo previo de la función \lstinline|GPIO_MODE_SET| para hacer las demás.
                ...
                \end{lstlisting}
            \item Recuerda empaquetar toda esta funcionalidad en un fichero \texttt{bsp.h} que irá dentro de la carpeta \texttt{Inc} del proyecto.
    ...
    \subsection{Para hacer más}
        ...
        Abre el proyecto BSP de ejemplo (dentro del paquete \texttt{STM32CubeF7}) e investiga cómo están organizadas las funciones, definiciones, registros... Para navegar por el proyecto, puedes ir haciendo \texttt{ctrl+click} en las llamadas a funciones o variables, y te llevará al fichero donde están definidas.
